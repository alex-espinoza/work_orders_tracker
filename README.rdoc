...
Carrierwave backgrounder: I don't want my app tied up when uploading and processing images, so it best to delegate these jobs to a background processor, which calls for...
